    ...
    return (
        <li>
            ...
            >
                ...
                {isActive && (
                    <span
                        className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-rose-500/0 via-rose-500/40 to-rose-500/0 dark:from-rose-400/0 dark:via-rose-400/40 dark:to-rose-400/0"/>
                )}
            </Link>
        </li>
    );
...
function ModeToggle() {
    ...
    return (
        ...
        >
            ...
            <MoonIcon
                className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-rose-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-rose-500"/>
        </button>
    );
}
